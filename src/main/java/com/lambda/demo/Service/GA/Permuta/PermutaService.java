...
public interface PermutaService {
    ...
    void addPermuta(int ram, int spazioArchiviazione, int batteria, String condizioneGenerale, String colore, List<String> immagine) throws GAException, InvalidRAMException, InvalidStorageException;
